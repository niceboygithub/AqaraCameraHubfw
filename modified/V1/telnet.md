# Enable Telnet of Aqara Smart Wall Hub V1

The easy way to enable telnet of Aqara Smart Wall Hub V1 is that flash customized firmware.
...
2. Copy the [kernel.bin and rootfs.bin](https://github.com/niceboygithub/AqaraCameraHubfw/tree/main/modified/V1/uboot) to USB disk in FAT32 format.
